...
regardless of how a given change was drafted.

In practice, that means:
- Every change is run and verified on real hardware before it's committed — nothing is
  assumed to work just because the code looks correct
